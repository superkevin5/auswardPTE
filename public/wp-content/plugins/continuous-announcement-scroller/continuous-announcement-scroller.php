...
function cas_control() 
{
	...
	echo '.</b> ';
	_e('Check official website for more information', 'continuous-announcement-scroller');
	?> <a target="_blank" href="<?php echo cas_FAV; ?>"><?php _e('click here', 'continuous-announcement-scroller'); ?></a></p><?php
}
