...
<div class="wrap">
  <div id="icon-edit" class="icon32 icon32-posts-post"></div>
	...
	<?php
	  ...
	  <a href="<?php echo WP_cas_ADMIN_URL; ?>&amp;ac=set"><input class="button action" type="button" value="<?php _e('Setting Management', 'continuous-announcement-scroller'); ?>" /></a>
	...
	<h3><?php _e('Plugin configuration option', 'continuous-announcement-scroller'); ?></h3>
	<ol>
		<li><?php _e('Add directly in to the theme using PHP code.', 'continuous-announcement-scroller'); ?></li>
		<li><?php _e('Drag and drop the widget to your sidebar.', 'continuous-announcement-scroller'); ?></li>
	</ol>
	<p class="description">
