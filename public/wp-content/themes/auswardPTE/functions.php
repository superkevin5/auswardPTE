...
function university_files() {
  ...
  wp_enqueue_script('lib', get_template_directory_uri() . '/js/lib.min.js', array('jquery'), '20120206', true );

  wp_enqueue_style('custom-google-fonts', '//fonts.googleapis.com/css?family=Roboto+Condensed:300,300i,400,400i,700,700i|Roboto:100,300,400,400i,700,700i');
  wp_enqueue_style('font-awesome', get_stylesheet_directory_uri() . '/css/font-awesome.css', array(), 20141119 );
  //wp_enqueue_style( 'bootstrap', get_stylesheet_directory_uri() . '/css/bootstrap.min.css', array(), 20141119 );
  wp_enqueue_style('index-style', get_stylesheet_directory_uri() . '/css/index-style.css', array(), 20141119 );

  wp_enqueue_style('school_main_styles', get_stylesheet_uri(), array(), time());
